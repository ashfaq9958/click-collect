...
const Featured = () => {
  ...
  return (
    <div className="mt-8">
      <div className="w-[90%] mx-auto p-6 lg:p-12 bg-white rounded-lg ">
          ...
          {features.map((feature) => (
            ...
            >
              <img
                src={feature.img}
                alt={feature.title}
                className="w-full h-60 object-contain rounded-lg transition-transform duration-500 transform group-hover:scale-110"
              />
