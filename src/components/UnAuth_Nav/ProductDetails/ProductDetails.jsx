...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const product = filterData.find((item) => item.key == id);
        ...
        <Box className="w-full md:w-[52%] p-3 md:p-8 space-y-3 sm:-mt-4 -mt-5 ">
          ...
          <div className="flex items-center space-x-4 font-roboto">
            ...
            <p className="text-md font-semibold text-gray-400 line-through">
              ₹{selectedProduct?.deletedPrice}
            </p>
            <span className="text-[11px] text-white font-bold bg-gradient-to-r from-red-500 to-red-600 px-2 py-1 rounded-tr-lg rounded-bl-lg">
